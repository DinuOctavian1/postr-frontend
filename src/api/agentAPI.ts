...
const Account = {
    ...
    confirmEmail: (data: IEmailConfirmation) => request.post(ENDPOINT.ConfirmEmail, data),
    forgotPassword: (data: IForgotPassword) => request.post(ENDPOINT.ForgotPassword, data),
    resetPassword: (data: IResetPassword) => request.post(ENDPOINT.ResetPassword, data),
